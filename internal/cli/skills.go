...
Run 'harbor skills check' to see all installed copies and their status.`,
}

var skillsInstallCmd = &cobra.Command{
	Use:   "install",
	Short: "Install the harbor skill",
	Long: `Install the harbor skill for your AI coding agent.
