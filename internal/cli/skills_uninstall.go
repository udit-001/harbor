...
import (
	...
	"github.com/udit-001/harbor/internal/skills"
)

var skillsUninstallCmd = &cobra.Command{
	Use:   "uninstall",
	Short: "Uninstall the harbor skill",
	Long: `Remove harbor skill files that were previously installed.

Scans the standard install locations (global + project) for installed
copies and offers interactive removal.

Examples:
  harbor skills uninstall
  harbor skills uninstall --all`,
	Args: cobra.NoArgs,
